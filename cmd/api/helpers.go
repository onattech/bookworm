...
// writeJSON is a helper function that encodes data to JSON and writes it to the
// http.ResponseWriter along with the specified HTTP status code and additional headers.
...
func (app *application) writeJSON(w http.ResponseWriter, status int, data envelope, headers http.Header) error {
	...
	// Add the "Content-Type: application/json" header, then write the HTTP status code
	// and the JSON response body to the response writer.
